...
export default function SearchAndFilters({ floating, search, setSearch, tags, pins, activeFilters, toggleFilter, clearFilters }) {
  const counts = {};
  ...
  return (
    <div className={`controls-block ${floating ? 'floating' : 'inline'}`}>
      <div className="searchpill">
        {iconSvg('search')}
        <input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search your pins…" />
      </div>
